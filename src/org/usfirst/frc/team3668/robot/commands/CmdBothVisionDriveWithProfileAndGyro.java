 ...
 *
 */
public class CmdBothVisionDriveWithProfileAndGyro extends Command {
...
//    	_requestedHeading = VisionProcessing.getGearCalculatedAngleFromTarget() + Robot.subChassis.gyroGetRawHeading();
    	if(goHalf){
